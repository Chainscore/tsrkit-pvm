...
def test_jam_refine():
    ...
    service = "counter"
    payload = b"inc"
    args = bytes.fromhex("")

    service_code = open(Path(__file__).parents[3] / "test-suite" / "playground" / "builds" / f"{service}-service.jam", "rb").read()
